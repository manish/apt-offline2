...
class Notifier(INotify):
    ...
    def increment_download(self, file_name):
        ...
        """
        self.downloaded += 1
        print("Notifier: Another package: %s | Total adds to: %s/%s\n" %(file_name, self.downloaded, self.total_count))
